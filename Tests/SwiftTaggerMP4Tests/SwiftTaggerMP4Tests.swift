...
//        tag.discNumber.totalDiscs = nil
    ...
    func testCreditLists() throws {
        ...
        tag.removePerformerCredit(.featuredArtist)
        tag.removePerformerCredit(.soloist)
        tag.removePerformerCredit(.narrator)
        tag.removePerformerCredit(.performer)
        XCTAssertNil(tag.artist)
        XCTAssertNil(tag.soloist)
        XCTAssertNil(tag.performers)
        XCTAssertNil(tag.narrator)
        
        tag.removeInvolvedPersonCredit(.artDirection)
        tag.removeInvolvedPersonCredit(.arranger)
        tag.removeInvolvedPersonCredit(.composer)
        tag.removeInvolvedPersonCredit(.conductor)
        tag.removeInvolvedPersonCredit(.director)
        tag.removeInvolvedPersonCredit(.executiveProducer)
        tag.removeInvolvedPersonCredit(.producer)
        tag.removeInvolvedPersonCredit(.publisher)
        tag.removeInvolvedPersonCredit(.soundEngineer)
        tag.removeInvolvedPersonCredit(.writer)
        ...
        output1.addPerformerCredit(.featuredArtist, person: "New Artist")
        output1.addPerformerCredit(.soloist, person: "New Soloist")
        output1.addPerformerCredit(.narrator, person: "New Narrator")
        output1.addPerformerCredit(.performer, person: "New Soprano")
        output1.addPerformerCredit(.performer, person: "New Alto")
        output1.addPerformerCredit(.performer, person: "New Tenor")
        output1.addPerformerCredit(.performer, person: "New Bass")
        output1.addPerformerCredit(.accompaniment, person: "New Accompanist")
        ...
        output2.removePerformerCredit(.soloist)
        output2.addPerformerCredit(.featuredArtist, person: "Other Artist")
        output2.addPerformerCredit(.accompaniment, person: "Other Accompanist")
